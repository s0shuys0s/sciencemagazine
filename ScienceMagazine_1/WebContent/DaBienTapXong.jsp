          ...
          <div class="row">
            <nav class="col-sm-2" id="myScrollspy">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class=""><a href="CacBaiVietDangPhanBien_TBT.jsp">Các bài viết đang phản biện</a></li>
                <li class="active"><a href="DaBienTapXong.jsp">Các bài viết đã được biên tập xong</a></li>
             </ul>
            </nav>
     </ul>
    </div>
         ...
         <fieldset>
          ...
          <div class="tab-content">
            ...
            <br>
              <div class="col-sm-8">
              <ul class="list-group">
                <li class="list-group-item"><a href="TBT_DaXong.jsp">Iphone 7 ra mắt vào ngày 09/09/2016 </a>
                <li class="list-group-item"><a href="">Dark Web rao bán 500 triệu tài khoản Yahoo lại bị hacker tấn công </a>
                <li class="list-group-item"><a href="">Dark Web rao bán 500 triệu tài khoản Yahoo lại bị hacker tấn công </a>
                <li class="list-group-item"><a href="">Dark Web rao bán 500 triệu tài khoản Yahoo lại bị hacker tấn công </a>
              </ul>
