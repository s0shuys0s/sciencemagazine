        ...
        <ul class="nav navbar-nav navbar-left">
          ...
          <div class="row">
            <nav class="col-sm-2" id="myScrollspy">
              <ul class="nav nav-pills nav-stacked">
                <li class=""><a href="Admin.jsp">Thông tin cá nhân</a></li>
                <li class="active"><a href="QuanLyThanhVien_Admin.jsp">Quản lý danh sách thành viên</a></li>
             </ul>
            </nav>
     </ul>
    </div>
        ...
        <form>
         <fieldset>
          ...
          <ul class="nav nav-pills">
              ...
              <li><a data-toggle="pill" href="#menu2">Tổng biên tập</a></li>
              <li><a data-toggle="pill" href="#menu3">Biên tập viên</a></li>
              <li><a data-toggle="pill" href="#menu4">Tác giả</a></li>
              <li><a data-toggle="pill" href="#menu5">Phản biện</a></li>
              <li><a data-toggle="pill" href="#menu6">Thành viên</a></li>
              <li><a data-toggle="pill" href="#menu7">Blocked</a></li>
              <li><form class="navbar-form navbar-side">
                  <div id="search">
<form class="searchform" action="" method="get">
<input class="s" onfocus="if (this.value == 'Search this website …') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Search this website …';}" type="text" name="s" value="Search members …" />
<input class="searchsubmit" type="submit" value="Search" />
            ...
            <div id="home" class="tab-pane fade in active">
              <div class="col-sm-8">
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <td><img src="lib/avatar.png" alt="HTML tutorial" style="width: 30px;height:30px;border:0;" align="left">  </td>
                        <td> Anna</td>
                        <td><div class="dropdown">
                        <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">
                        <span class="glyphicon glyphicon-cog"></span></button>
                        <ul class="dropdown-menu">
                          <li><a href="#"><font color = "red">Block</font></a></li>
                          <li role="presentation" class="divider"></li>
                          <li  class="disabled"><a href="#">Set as Admin</a></li>
                          <li><a href="#">Set as Tác giả</a></li>
                          <li><a href="#">Set as Tổng biên tập</a></li>
                          <li><a href="#">Set as Biên tập viên</a></li>
                          <li><a href="#">Set as Phản biện</a></li>
                          <li><a href="#">Set as Thành viên</a></li>
                        </ul>
                         </div></td>
                      </tr>
                      <tr>
    ...
    <div id="menu7" class="tab-pane fade">
     <div class="col-sm-8">
              ...
              <span class="glyphicon glyphicon-cog"></span></button>
              <ul class="dropdown-menu">
                <li><a href="#"><font color = "blue">UnBlock</font></a></li>
...
<button type="button" class="btn button-Khóa">2</button></h4>
<button type="button" class="btn button-Khóa">3</button></h4>
<button type="button" class="btn button-Khóa">></button></h4>
<button type="button" class="btn button-Khóa">>></button></h4>
</div></div>
<br>
