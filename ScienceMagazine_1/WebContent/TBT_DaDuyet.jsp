...
<head>
  ...
  <title>Giao bài cho phản biện</title>
          ...
          <div class="row">
            <nav class="col-sm-2" id="myScrollspy">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="TBT_DaDuyet.jsp">Các bài viết đã kiểm duyệt</a></li>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td> <a href="TBT_DocBai.jsp">Nghiên cứu về trồng cây công nghiệp</a></td>
                        <td> 22-10-2016</td>
                       <td> <div class="col-sm-10">
                           <select id="selectBox" onchange="changeFunc();">
                      <option>Chờ đăng</option>
                      <option value="1">Đổi ngày</option>
                     <option>Hủy đăng bài</option>
                      </select>
                        </div> </td>
                      </tr>
                      <tr>
                        <td> <img src="lib/avatar.png" alt="HTML tutorial" style="width: 30px;height:30px;border:0;" align="left"></td>
                        <td>  <a href="TBT_DocBai.jsp">Khám phá đột biến gen ở người</a></td>
                         <td> 22-10-2016</td>
                          <td> <div class="col-sm-10">
                           <select id="selectBox" onchange="changeFunc();">
                      <option>Chờ đăng</option>
                     ...
                     <option>Hủy đăng bài</option>
                      ...
                      <tr>
                        <td> <img src="lib/avatar.png" alt="HTML tutorial" style="width: 30px;height:30px;border:0;" align="left"></td>
                        <td><a href="TBT_DocBai.jsp">Tạp chí công nghệ số 8</a></td>
                         <td> 22-10-2016</td>
                          <td> <div class="col-sm-10">
                           <select id="selectBox" onchange="changeFunc();">
                      <option>Chờ đăng</option>
