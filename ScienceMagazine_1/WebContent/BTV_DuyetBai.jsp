...
<div class="container-fluid text-left">
    ...
    <td>
    <form class="inline">
              <div class="col-sm-8"><button type="submit" class="btn btn-success btn-block">Gửi cho TBT</button>
              <button type="submit" class="btn btn-success btn-block">Hủy bài</button>
              </div>
              </form>
            </form>
          </td>
