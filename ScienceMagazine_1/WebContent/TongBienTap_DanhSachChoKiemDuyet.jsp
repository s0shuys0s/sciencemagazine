...
<div class="container-fluid text-center">
  <div class="row content">
          ...
          <div class="row">
            <nav class="col-sm-2" id="myScrollspy">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a hactivef="TongBienTap_DanhSachChoKiemDuyet.jsp">Các bài viết chờ kiểm duyệt</a></li>
    ...
    <div class="col-sm-8 text-left">
        <form>
         <fieldset>
          <legend><label><font color="red">Danh sách bài viết</font></label></legend>
          <div class="container">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td> <a href="GiaoBaiChoPhanBien.jsp">Nghiên cứu về trồng cây công nghiệp</a></td>
                        <td> 22-10-2016</td>
                      ...
                      <option value="1" disabled>---</option>
                       <option value="2">Chưa duyệt</option>
                        <option value="3">Đã duyệt</option>
                         <option value="4">Giao lại cho tác giả</option>
                          <option value="5">Giao cho BTV</option>
                           <option value="6">Giao cho phản biện</option>
                           <option value="7">Đang phản biện</option>
                           <option value="8">Hủy bài</option>
                      </select>
                        </div> </td>
                      </tr>
                      <tr>
                        <td> <img src="lib/avatar.png" alt="HTML tutorial" style="width: 30px;height:30px;border:0;" align="left"></td>
                        <td>  <a href="DangPhanBien.jsp">Khám phá đột biến gen ở người</a></td>
                         <td> 22-10-2016</td>
                         <td> <div class="col-sm-10">
                           <select id="selectBox" onchange="changeFunc();">
                      <option value="1" disabled>---</option>
                      ...
                      <tr>
                        <td> <img src="lib/avatar.png" alt="HTML tutorial" style="width: 30px;height:30px;border:0;" align="left"></td>
                        <td><a href="TBT_DaXong.jsp">Tạp chí công nghệ số 8</a></td>
                         <td> 22-10-2016</td>
                         <td> <div class="col-sm-10">
                           <select id="selectBox" onchange="changeFunc();">
                       <option value="1" disabled>---</option>
...
<button type="button" class="btn button-Khóa">>></button></h4>
   ...
   function changeFunc() {
    ...
    if(selectedValue=="6")
      window.location="GiaoBaiChoPhanBien.jsp";
    else if(selectedValue=="5")
    	 window.location="TBT_DaXong.jsp";
    else if(selectedValue=="7")
   	 window.location="DangPhanBien.jsp";
    else if(selectedValue=="4")
      	 window.location="DangPhanBien.jsp";
    else if(selectedValue=="3")
     	 window.location="TBT_DangBai.jsp";
   }
