  ...
  <table class="table table-bordered">
    <tbody>
      <tr>
        <td>
            <div class="col-sm-4">
          <h2><font color="red">CẬP NHẬT TÀI KHOẢN</font></h2>
        </div>
           <div id="main" ng-app="DangKiApp" ng-controller="RegisterCtrl">
            <form class="form-horizontal" name="form" ng-submit="register()" novalidate>
                    ...
                    <div ng-show="success" class="text-success text-center">Cập nhật thành công !</div>
                    </div>
            ...
            <div class="form-group has-feedback" show-errors='{showSuccess: true}'>
              ...
              <div class="col-sm-8">
                <input id="fullname" name="fullname" type="text" class="form-control"
                 placeholder="Nguyễn Đức Huy"  ng-model="fullname"  ng-minlength="6"
            ...
            <div class="form-group has-feedback" show-errors='{showSuccess: true}'>
              ...
              <div class="col-sm-8">
                <input id="CMND" name="CMND" type="text" class="form-control"
                 placeholder="025386817"  ng-model="CMND"  ng-minlength="9"
            ...
            <div class="form-group has-feedback" show-errors='{showSuccess: true}'>
              ...
              <div class="col-sm-8">
                <input id="noicap" name="noicap" type="text" class="form-control"
                 placeholder="TPHCM"  ng-model="noicap"  ng-minlength="0"
            ...
            <div class="form-group has-feedback" show-errors='{showSuccess: true}'>
              ...
              <div class="col-sm-8">
                <input id="diachi" name="diachi" type="text" class="form-control"
                 placeholder="47 đường 5, phường Tăng Nhơn Phú B, quận 9"  ng-model="diachi"  ng-minlength="0"
                 ng-maxlength="50" required>
             ...
             <div class="form-group has-feedback" show-errors='{showSuccess: true}'>
              ...
              <div class="col-sm-8">
                <input id="phone" name="phone" type="text" class="form-control"
                 placeholder="01689030412"  ng-model="phone"  ng-minlength="9"
            ...
            <div class="form-group has-feedback" show-errors='{showSuccess: true}'>
              ...
              <div class="col-sm-8">
                <input id="email" name="email" type="email" class="form-control" placeholder="n.duchuy_96@yahoo.com"
