          ...
          <td>
            <form class="form-horizontal">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <textarea rows="2" cols="40">Iphone 7 ra mắt vào ngày 09/09/2016</textarea>
                </div>
              ...
              <br>
              <label class="control-label col-sm-12" for="inf"><h3><font color="blue">Gửi cho BTV</font></h3></label>
            <label><font color="orange">BTV</font></label>
            <form class="form-horizontal">
              <div class="form-group">
            ...
            <form class="inline">
              <div class="col-sm-8"><button type="submit" class="btn btn-success btn-block">Gửi cho BTV</button></div>
              </form>
            </form>
          </td>              
            </form>
