          ...
          <div class="row">
            <nav class="col-sm-2" id="myScrollspy">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class=""><a href="BaiVietSua_BTV.jsp">Các bài viết</a></li>
                <li class="active"><a href="BTV_ChinhSua.jsp">Bài viết được giao chỉnh sửa</a></li>
             </ul>
            </nav>
     </ul>
    </div>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td> <a href="BTV_DaChinhSua.jsp">Nghiên cứu về trồng cây công nghiệp</a></td>
                        <td> 22-10-2016</td>
                        <td> <div class="col-sm-10">
                           <select id="selectBox" onchange="changeFunc();">
                      <option value="1" disabled>---</option>
                       <option value="2">Đã sửa</option>
                         <option value="3">Chưa sửa</option>
                      </select>
                        </div> </td>
                      </tr>
                      <tr>
                        <td> <img src="lib/avatar.png" alt="HTML tutorial" style="width: 30px;height:30px;border:0;" align="left"></td>
                        <td>  <a href="BTV_DaChinhSua2.jsp">Khám phá đột biến gen ở người</a></td>
                         <td> 22-10-2016</td>
                         <td> <div class="col-sm-10">
                           <select id="selectBox" onchange="changeFunc();">
                      <option value="1" disabled>---</option>
                      ...
                      <tr>
                        <td> <img src="lib/avatar.png" alt="HTML tutorial" style="width: 30px;height:30px;border:0;" align="left"></td>
                        <td><a href="BTV_DaChinhSua2.jsp">Tạp chí công nghệ số 8</a></td>
                         <td> 22-10-2016</td>
                         <td> <div class="col-sm-10">
                           <select id="selectBox" onchange="changeFunc();">
                        <option value="1" disabled>---</option>
 ...
 <script type="text/javascript">
   ...
   function changeFunc() {
    ...
    var selectedValue = selectBox.options[selectBox.selectedIndex].value;
	 if(selectedValue=="3")
     	 window.location="BTV_DuyetBai.jsp";
	 else if(selectedValue=="2")
     	 window.location="BTV_DaChinhSua2.jsp";
   }
