...
<div class="container-fluid text-left">
    ...
    <label class="control-label col-sm-2" for="bvm"><h4><font color="blue">BÀI VIẾT</font></h4></label></td>
    ...
    <td>
            <label class="control-label col-sm-12" for="inf"><h3><font color="blue">Gửi cho phản biện</font></h3></label>
            <label><font color="orange">Người phản biện</font></label>
            ...
            <form class="inline">
              <div class="col-sm-8"><button type="submit" class="btn btn-success btn-block">Gửi cho phản biện</button></div>
              </form>
            </form>
          </td>
    </div>
