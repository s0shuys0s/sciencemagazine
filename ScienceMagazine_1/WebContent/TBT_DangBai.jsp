          ...
          <div class="row">
            <nav class="col-sm-2" id="myScrollspy">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="TongBienTap_DanhSachChoKiemDuyet.jsp">Các bài viết chờ kiểm duyệt</a></li>
...
<div class="container-fluid text-left">
    ...
    <td>
            <label class="control-label col-sm-12" for="inf"><h3><font color="blue">Đăng bài</font></h3></label>
            
            <form class="form-horizontal">
              <div class="form-group">
              <label class="col-sm-4">Lĩnh vực :</label>
            ...
            <form class="inline">
              <div class="col-sm-8"><button type="submit" class="btn btn-success btn-block">Đăng</button></div>
              </form>
            </form>
          </td>
    </div>
